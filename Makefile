...
COMPONENTS := ingest-gateway control-api query-api analysis-engine event-writer detection-writer alert-writer inventory-projector store-migrator backbone-migrator control-migrator
VERSION ?= dev
