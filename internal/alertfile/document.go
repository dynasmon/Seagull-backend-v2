// Package alertfile reads how alerts are folded, and which never become work,
// out of a YAML document. It decides nothing: what it produces is an alert
// tuning, and internal/alert is what folds and suppresses.
package alertfile
...
// Unread keys are refused rather than defaulted: `supressions:` for
// `suppressions:` must never read as "nothing is suppressed".
type mapping struct {
	node  *yaml.Node
